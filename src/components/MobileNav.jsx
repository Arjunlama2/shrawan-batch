...
function MobileNav() {
  return (
    <div className="md:hidden fixed top-12   bg-black/70 w-full h-[100vh] ">
      <div className="absolute right-0 flex flex-col gap-5 items-center w-1/2 h-full bg-red-600 text-white   ">
